package com.cvaccari.customviews.circleimageview
...
open class CircleImageView @JvmOverloads constructor(
    ...
    fun setGradiente() {
        val colorList = intArrayOf(R.color.colorAccent, R.color.colorAccent)
        val shader = SweepGradient(mStrokeBounds.width(), mStrokeBounds.height(), colorList, null)
        mStrokePaint.shader = shader
    }
